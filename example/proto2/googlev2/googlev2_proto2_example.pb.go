...
type EventUsingWKTs struct {
	...
	EventType *EventType             `protobuf:"varint,3,opt,name=event_type,json=eventType,enum=crowdstrike.csproto.example.proto2.googlev2.EventType" json:"event_type,omitempty"`
}
...
func (*EventUsingWKTs) Descriptor() ([]byte, []int) {
	return file_googlev2_proto2_example_proto_rawDescGZIP(), []int{5}
}
...
func (x *TestEvent_NestedMsg) Reset() {
	*x = TestEvent_NestedMsg{}
	if protoimpl.UnsafeEnabled {
		mi := &file_googlev2_proto2_example_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_googlev2_proto2_example_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x32, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x76, 0x32, 0x1a, 0x1f, 0x67, 0x6f,
	...
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x76, 0x32, 0x2e, 0x54, 0x65, 0x73, 0x74, 0x45, 0x76,
	...
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x76, 0x32, 0x2e, 0x42, 0x61, 0x73, 0x65, 0x45, 0x76, 0x65, 0x6e,
	...
	0x67, 0x6c, 0x65, 0x76, 0x32, 0x2e, 0x54, 0x65, 0x73, 0x74, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x52,
	...
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x76, 0x32, 0x2e, 0x45, 0x6d, 0x62, 0x65, 0x64, 0x64, 0x65,
	...
	0x70, 0x65, 0x52, 0x09, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x2a, 0x4d, 0x0a,
	...
	0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x2f, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x76, 0x32,
}
...
var file_googlev2_proto2_example_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_googlev2_proto2_example_proto_goTypes = []interface{}{
	...
	(*EventUsingWKTs)(nil),        // 6: crowdstrike.csproto.example.proto2.googlev2.EventUsingWKTs
	(*TestEvent_NestedMsg)(nil),   // 7: crowdstrike.csproto.example.proto2.googlev2.TestEvent.NestedMsg
...
var file_googlev2_proto2_example_proto_depIdxs = []int32{
	...
	7,  // 2: crowdstrike.csproto.example.proto2.googlev2.TestEvent.nested:type_name -> crowdstrike.csproto.example.proto2.googlev2.TestEvent.NestedMsg
	...
	8,  // 7: crowdstrike.csproto.example.proto2.googlev2.EventUsingWKTs.ts:type_name -> google.protobuf.Timestamp
	0,  // 8: crowdstrike.csproto.example.proto2.googlev2.EventUsingWKTs.event_type:type_name -> crowdstrike.csproto.example.proto2.googlev2.EventType
	1,  // 9: crowdstrike.csproto.example.proto2.googlev2.TestEvent.eventExt:extendee -> crowdstrike.csproto.example.proto2.googlev2.BaseEvent
	2,  // 10: crowdstrike.csproto.example.proto2.googlev2.TestEvent.eventExt:type_name -> crowdstrike.csproto.example.proto2.googlev2.TestEvent
...
func file_googlev2_proto2_example_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_googlev2_proto2_example_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
