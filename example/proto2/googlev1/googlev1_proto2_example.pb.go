...
var file_googlev1_proto2_example_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_googlev1_proto2_example_proto_goTypes = []interface{}{
	...
	(*TestEvent_NestedMsg)(nil),   // 7: crowdstrike.csproto.example.proto2.googlev1.TestEvent.NestedMsg
...
var file_googlev1_proto2_example_proto_depIdxs = []int32{
	...
	7,  // 2: crowdstrike.csproto.example.proto2.googlev1.TestEvent.nested:type_name -> crowdstrike.csproto.example.proto2.googlev1.TestEvent.NestedMsg
	...
	8,  // 7: crowdstrike.csproto.example.proto2.googlev1.EventUsingWKTs.ts:type_name -> google.protobuf.Timestamp
	...
	1,  // 9: crowdstrike.csproto.example.proto2.googlev1.TestEvent.eventExt:extendee -> crowdstrike.csproto.example.proto2.googlev1.BaseEvent
	2,  // 10: crowdstrike.csproto.example.proto2.googlev1.TestEvent.eventExt:type_name -> crowdstrike.csproto.example.proto2.googlev1.TestEvent
