...
func file_googlev2_proto3_example_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_googlev2_proto3_example_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Msg); i {
			case 0:
				return &v.state
			case 1:
		...
		file_googlev2_proto3_example_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_googlev2_proto3_example_proto_msgTypes[30].Exporter = func(v interface{}, i int) interface{} {
	...
	file_googlev2_proto3_example_proto_msgTypes[8].OneofWrappers = []interface{}{
		(*I18NVariable_OptOne)(nil),
		(*I18NVariable_OptTwo)(nil),
	}
	file_googlev2_proto3_example_proto_msgTypes[9].OneofWrappers = []interface{}{
		(*Msg_Tags_)(nil),
	}
	type x struct{}
