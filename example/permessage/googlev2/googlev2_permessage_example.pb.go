...
var file_googlev2_permessage_example_proto_goTypes = []any{
...
func file_googlev2_permessage_example_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_googlev2_permessage_example_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_googlev2_permessage_example_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_googlev2_permessage_example_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_googlev2_permessage_example_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_googlev2_permessage_example_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_googlev2_permessage_example_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_googlev2_permessage_example_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*Msg); i {
			case 0:
				return &v.state
			case 1:
		...
		file_googlev2_permessage_example_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_googlev2_permessage_example_proto_msgTypes[24].Exporter = func(v any, i int) any {
	...
	file_googlev2_permessage_example_proto_msgTypes[0].OneofWrappers = []any{
		(*TestEvent_Jedi)(nil),
		(*TestEvent_Sith)(nil),
		(*TestEvent_Other)(nil),
	}
	file_googlev2_permessage_example_proto_msgTypes[5].OneofWrappers = []any{
		(*I18NVariable_OptOne)(nil),
		(*I18NVariable_OptTwo)(nil),
	}
	file_googlev2_permessage_example_proto_msgTypes[6].OneofWrappers = []any{
		(*Msg_Tags_)(nil),
	}
	type x struct{}
