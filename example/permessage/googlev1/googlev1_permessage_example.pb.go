...
func (*I18NVariable) Descriptor() ([]byte, []int) {
	return file_googlev1_permessage_example_proto_rawDescGZIP(), []int{5}
}
...
func (x *Msg) Reset() {
	*x = Msg{}
	if protoimpl.UnsafeEnabled {
		mi := &file_googlev1_permessage_example_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Msg) Descriptor() ([]byte, []int) {
	return file_googlev1_permessage_example_proto_rawDescGZIP(), []int{6}
}
...
func (x *TestEvent_NestedMsg) Reset() {
	*x = TestEvent_NestedMsg{}
	if protoimpl.UnsafeEnabled {
		mi := &file_googlev1_permessage_example_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *Msg_Tags) Reset() {
	*x = Msg_Tags{}
	if protoimpl.UnsafeEnabled {
		mi := &file_googlev1_permessage_example_proto_msgTypes[24]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Msg_Tags) Descriptor() ([]byte, []int) {
	return file_googlev1_permessage_example_proto_rawDescGZIP(), []int{6, 0}
}
...
var file_googlev1_permessage_example_proto_rawDesc = []byte{
	...
	0x6f, 0x77, 0x64, 0x73, 0x74, 0x72, 0x69, 0x6b, 0x65, 0x2e, 0x63, 0x73, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x2e, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x70, 0x65, 0x72, 0x6d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x76, 0x31, 0x2e, 0x4d, 0x73,
	...
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_googlev1_permessage_example_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_googlev1_permessage_example_proto_goTypes = []interface{}{
	...
	(*I18NVariable)(nil),        // 6: crowdstrike.csproto.example.permessage.googlev1.I18nVariable
	(*Msg)(nil),                 // 7: crowdstrike.csproto.example.permessage.googlev1.Msg
	(*TestEvent_NestedMsg)(nil), // 8: crowdstrike.csproto.example.permessage.googlev1.TestEvent.NestedMsg
	nil,                         // 9: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToInt32Entry
	nil,                         // 10: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToInt64Entry
	nil,                         // 11: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToUInt32Entry
	nil,                         // 12: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToUInt64Entry
	nil,                         // 13: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToStringEntry
	nil,                         // 14: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToBytesEntry
	nil,                         // 15: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToSInt32Entry
	nil,                         // 16: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToSInt64Entry
	nil,                         // 17: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToFixed32Entry
	nil,                         // 18: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToSFixed32Entry
	nil,                         // 19: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToFixed64Entry
	nil,                         // 20: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToSFixed64Entry
	nil,                         // 21: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToFloatEntry
	nil,                         // 22: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToDoubleEntry
	nil,                         // 23: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToMessageEntry
	nil,                         // 24: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToEnumEntry
	(*Msg_Tags)(nil),            // 25: crowdstrike.csproto.example.permessage.googlev1.Msg.Tags
}
var file_googlev1_permessage_example_proto_depIdxs = []int32{
	...
	8,  // 1: crowdstrike.csproto.example.permessage.googlev1.TestEvent.nested:type_name -> crowdstrike.csproto.example.permessage.googlev1.TestEvent.NestedMsg
	...
	9,  // 6: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.toInt32:type_name -> crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToInt32Entry
	10, // 7: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.toInt64:type_name -> crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToInt64Entry
	11, // 8: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.toUInt32:type_name -> crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToUInt32Entry
	12, // 9: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.toUInt64:type_name -> crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToUInt64Entry
	13, // 10: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.toString:type_name -> crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToStringEntry
	14, // 11: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.toBytes:type_name -> crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToBytesEntry
	15, // 12: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.toSInt32:type_name -> crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToSInt32Entry
	16, // 13: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.toSInt64:type_name -> crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToSInt64Entry
	17, // 14: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.toFixed32:type_name -> crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToFixed32Entry
	18, // 15: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.toSFixed32:type_name -> crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToSFixed32Entry
	19, // 16: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.toFixed64:type_name -> crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToFixed64Entry
	20, // 17: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.toSFixed64:type_name -> crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToSFixed64Entry
	21, // 18: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.toFloat:type_name -> crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToFloatEntry
	22, // 19: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.toDouble:type_name -> crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToDoubleEntry
	23, // 20: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.toMessage:type_name -> crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToMessageEntry
	24, // 21: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.toEnum:type_name -> crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToEnumEntry
	25, // 22: crowdstrike.csproto.example.permessage.googlev1.Msg.tags:type_name -> crowdstrike.csproto.example.permessage.googlev1.Msg.Tags
	2,  // 23: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToMessageEntry.value:type_name -> crowdstrike.csproto.example.permessage.googlev1.EmbeddedEvent
	0,  // 24: crowdstrike.csproto.example.permessage.googlev1.AllTheMaps.ToEnumEntry.value:type_name -> crowdstrike.csproto.example.permessage.googlev1.EventType
...
func file_googlev1_permessage_example_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_googlev1_permessage_example_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Msg); i {
			case 0:
				return &v.state
			case 1:
		...
		file_googlev1_permessage_example_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_googlev1_permessage_example_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
	...
	file_googlev1_permessage_example_proto_msgTypes[5].OneofWrappers = []interface{}{
		(*I18NVariable_OptOne)(nil),
		(*I18NVariable_OptTwo)(nil),
	}
	file_googlev1_permessage_example_proto_msgTypes[6].OneofWrappers = []interface{}{
		(*Msg_Tags_)(nil),
	}
	type x struct{}
