...
import (
	...
	"github.com/CrowdStrike/csproto/example/permessage/googlev2"
)

func TestMapFieldsUnmarshalAfterGoogleV2Marshal(t *testing.T) {
	var msg, msg2 googlev2.AllTheMaps

	msg = googlev2.AllTheMaps{
		...
		ToMessage:  map[string]*googlev2.EmbeddedEvent{"one": {ID: 1}, "two": {ID: 2}},
		ToEnum:     map[string]googlev2.EventType{"one": googlev2.EventType_EVENT_TYPE_ONE, "two": googlev2.EventType_EVENT_TYPE_TWO},
	}
...
func TestGoogleV2UnmarshalMapFieldsAfterCustomMarshal(t *testing.T) {
	var msg, msg2 googlev2.AllTheMaps
